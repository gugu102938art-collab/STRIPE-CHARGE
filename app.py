...
# --- your variables (DO NOT keep secrets in code if this goes public!) ---
BOT_TOKEN = "8269027923:AAGk22DMoMj1qUgeSl_LXaR8nYFL_E9W0Q4"
...
def stripe_charge_full_check(cc, mm, yy, cvv):
    # your entire function code pasted here
    pass


# === Your API endpoint where you receive numbers ===
...
def check():
    ...
    # call your function
    result = stripe_charge_full_check(cc, mm, yy, cvv)
